...
function pelaa() {
   ...
   if (lukko3 == 0) {
    ...
    document.getElementById("lukko1").src = "./img/" + images[slot1];
    document.getElementById("lukko2").src = "./img/" + images[slot2];
    document.getElementById("lukko3").src = "./img/" + images[slot3];
